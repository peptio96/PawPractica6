        ...
        <c:if test="${cliente!=null}"><jsp:include page="clientes/cabeceraRegistrado.html"/></c:if>
            <div class="sombra">
                <div class="nucleo">
                    ...
                    <c:if test="${cliente==null}"><a href="BuscarArticulos" title="Hojear catalogo">Hojear catalogo</a></c:if>
                    <c:if test="${cliente!=null}"><a href="/pr6/BuscarArticulos" title="Hojear catalogo">Hojear catalogo</a></c:if><!-- &nbsp; | &nbsp; 
