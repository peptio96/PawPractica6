<%-- 
    ...
    Created on : Apr 2, 2019, 4:30:05 PM
    Author     : alruiz_o
--%>
                ...
                <div class="contenido">
                    ...
                    <form name="fCliente" id="fCliente" action="NuevoCliente" method="post">
                        ...
                        <fieldset> 
                            ...
                            <div class="field">
                                <label for="nombreUsuario">Nombre de usuario:<c:if test="${nombreUsuario==null || nombreUsuario==''}"><span class="Requerido">Requerido</span></c:if></label>
                                <input class="text" type="text" name="nombreUsuario" id="nombreUsuario" size="10" value="${nombreUsuario}" />
                            </div>

                            <div>
                                <div class="left">
                                    <div class="field">
                                        <label for="contrasena">Contraseña:<c:if test="${contrasena==null || contrasena==''}"><span class="Requerido">Requerido</span></c:if></label>
                                        <input class="text" type="password" name="contrasena" id="contrasena" size="10" value="${contrasena}" />
                                    </div>
                                </div>					

                                <div class="right">
                                    <div class="field">
                                        <label for="repContrasena">Repita contraseña:<c:if test="${repContrasena==null || repContrasena==''}"><span class="Requerido">Requerido</span></c:if></label>
                                        <input class="text" type="password" name="repContrasena" id="repContrasena" size="10" value="${repContrasena}" />
                                    </div>
                                </div>		
                            </div>
                        </fieldset>
